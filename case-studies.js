          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            >
              ...
              <p className="text-gray-600">
                We begin by deeply understanding your business goals, user needs, and technical landscape to develop a strategic direction.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">
                We design and prototype AI experiences, testing with real users to ensure they deliver value and delight.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">
                We assemble the right team to implement solutions, then continuously optimize based on performance data.
              </p>
            </motion.div>
          </div>
